...
class extends Component {
    ...
    // Tags (optional, simplified as string or array depending on UI, lets assume basic select or text for now)
    // For MVP/Space, I'll list tags as IDs if implemented
    public $selectedTags = [];
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="mb-6">
        <h1 class="text-2xl font-bold text-zinc-900 dark:text-white">Crear Nuevo Artículo</h1>
    </div>
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        <label class="block w-full cursor-pointer rounded-md border-2 border-dashed border-zinc-300 p-4 text-center hover:border-zinc-400 dark:border-zinc-700 dark:hover:border-zinc-600">
                            <span class="text-sm text-zinc-500 dark:text-zinc-400">Click para subir imagen</span>
