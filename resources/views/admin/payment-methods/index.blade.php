    ...
    <div class="p-6 space-y-6">
        ...
        <div class="grid gap-4 md:grid-cols-2">
            ...
            <div class="rounded-xl border border-zinc-200 bg-white p-6 dark:border-zinc-700 dark:bg-zinc-900">
                ...
                <a href="{{ route('dashboard.payment-methods.edit', $method->id) }}" class="inline-flex justify-center rounded-lg border border-zinc-200 bg-white px-4 py-2 text-sm font-medium text-zinc-900 hover:bg-zinc-100/50 focus:outline-none focus:ring-2 focus:ring-pink-500 dark:border-zinc-700 dark:bg-zinc-800 dark:text-white dark:hover:bg-zinc-700 dark:focus:ring-offset-zinc-900 transition-colors w-full">Configurar</a>
            </div>
            @endforeach
        </div>
    </div>
