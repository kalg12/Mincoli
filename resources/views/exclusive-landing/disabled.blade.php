...
<head>
    ...
    <title>No disponible | Mincoli</title>
...
<body class="min-h-screen bg-gradient-to-br from-pink-50 to-white flex items-center justify-center p-4">
    <div class="w-full max-w-md">
        <div class="bg-white rounded-2xl shadow-xl p-8 text-center">
            ...
            <h1 class="text-2xl font-bold text-gray-900 mb-4">No disponible</h1>
            <p class="text-gray-600 mb-6">El contenido exclusivo no está disponible en este momento.</p>
